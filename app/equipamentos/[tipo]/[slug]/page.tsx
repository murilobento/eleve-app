...
export async function generateMetadata({ params }: EquipmentPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      locale: "pt_BR",
      type: "article",
      images: [{ url: equipment.imageUrl, alt: equipment.imageAlt || equipment.name }],
    },
    twitter: {
...
export default async function EquipmentPage({ params }: EquipmentPageProps) {
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-white text-gray-950 dark:bg-[#121212] dark:text-white">
        <section className="relative overflow-hidden bg-gray-950 px-4 pb-24 pt-44 text-white md:px-6 md:pb-32 md:pt-52">
          <img
          ...
          <div className="relative mx-auto max-w-5xl">
            ...
            <p className="mt-4 text-sm font-bold uppercase tracking-[0.3em] text-white/70">{equipment.model}</p>
        ...
        <section className="mx-auto grid max-w-6xl gap-12 px-4 py-20 md:px-6 lg:grid-cols-[1fr_18rem]">
          ...
          <aside className="space-y-4">
            <div className="rounded-2xl border border-black/5 bg-gray-50 p-6 dark:border-white/10 dark:bg-[#1A1A1A]">
        ...
        <section className="bg-gray-100 px-4 py-20 dark:bg-[#1A1A1A] md:px-6">
              ...
              <div className="mt-6 grid gap-3">
                {relatedEquipment.map((item) => (
                  <a
                    ...
                    className="rounded-xl border border-black/5 bg-white p-4 font-bold transition-colors hover:bg-[#FCD34D] dark:border-white/10 dark:bg-[#222222] dark:hover:bg-[#FCD34D] dark:hover:text-black"
                  >
                    {item.name}
                  </a>
                ))}
