...
export function LandingNavbar() {
  ...
  const navigationItems = [
    ...
    { name: t("navigation.solutions"), href: '#features', hasMegaMenu: true },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
        ...
        <div className="hidden xl:flex items-center space-x-2">
          ...
          <Button variant="outline" asChild className="cursor-pointer">
            <a href={getAppUrl("/dashboard", locale)} target="_blank" rel="noopener noreferrer">
              ...
              <div className="border-t p-6 space-y-4">
                ...
                <div className="space-y-3">
                  <Button variant="outline" size="lg" asChild className="w-full cursor-pointer">
                    <a href={getAppUrl("/dashboard", locale)}>
