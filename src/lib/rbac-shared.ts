export const PERMISSION_CATALOG = [
  ...
  { key: "public-site.read", resource: "public-site", action: "read", description: "View public site content." },
  { key: "public-site.create", resource: "public-site", action: "create", description: "Create public site content." },
  { key: "public-site.update", resource: "public-site", action: "update", description: "Edit public site content." },
  { key: "public-site.delete", resource: "public-site", action: "delete", description: "Delete public site content." },
